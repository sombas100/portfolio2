...
export const SKILLS = [
  {
    ...
    title: "JavaScript",
    comment: `JavaScript is my bread and butter. I've been working with it for over 2 years and have built numerous applications, ranging from simple scripts to complex web applications.`,
  },
  {
    id: "02",
    icon: IoLogoHtml5,
...
export const ABOUT_ME_DATA = {
  introduction: "Hi, I'm Corey, an experienced React JS developer passionate about building engaging web applications and solving complex problems with code.",
  background: "I hold a Bachelor's degree in Computer Science from Arden University. Over the past 2 years, I've gained valuable experience in frontend development, working on projects ranging from e-commerce websites to interactive dashboards.",
  skills: "I'm proficient in a variety of technologies including React.js, TypeScript, JavaScript, HTML, CSS, and Node.js. I'm also experienced in using version control systems like Git and working with RESTful APIs.",
  ...
  interests: "Outside of coding, I enjoy traveling to new places, working out at the gym, and playing a variety of video games. I'm also an avid reader and love learning new languages.",
